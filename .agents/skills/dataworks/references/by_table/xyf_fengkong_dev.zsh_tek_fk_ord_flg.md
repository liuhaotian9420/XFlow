...
| --- | --- | --- | --- | --- |
| order_number | STRING | column |  | Y |
| id_card_number | STRING | column |  |  |
| created_time | DATETIME | column |  |  |
| decision_time | DATETIME | column |  |  |
| cashloan_order_periods | DOUBLE | column |  |  |
| tek_apl_amt_rte_b | DOUBLE | column |  |  |
| fd_multiple_draw_creditlevel_stock_creditlevel_cross_3_hz | STRING | column |  |  |
| fd_multiple_draw_creditlevel_stock_creditlevel_cross_6_hz | STRING | column |  |  |
| fd_multiple_draw_creditlevel_stock_creditlevel_cross_12_hz | STRING | column |  |  |
| 综合评级 | STRING | column |  |  |
| str_ver | STRING | column |  |  |
| tek_fk_ord_flg | STRING | column |  | Y |
| tek_fk_ord_flg_new | STRING | column |  |  |
| old_str_ver_add_fy | STRING | column |  |  |
