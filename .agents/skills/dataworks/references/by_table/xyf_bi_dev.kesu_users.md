...
| --- | --- | --- | --- | --- |
| month_cj | STRING | column |  |  |
| is_zq | STRING | column |  |  |
| cust_no | STRING | column |  |  |
| id_card_number | STRING | column |  |  |
| task_type_name_new | STRING | column |  |  |
| order_number_source | STRING | column |  |  |
| channel_1_type_new | STRING | column |  |  |
| order_number1 | STRING | column |  |  |
| cust_status | STRING | column |  |  |
| task_number | STRING | column |  |  |
| cjdate | STRING | column |  |  |
