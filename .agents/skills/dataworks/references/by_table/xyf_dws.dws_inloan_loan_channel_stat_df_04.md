...
| --- | --- | --- | --- | --- |
| loan_month | STRING | column |  | Y |
| act_first_api_p_mthly_id | BIGINT | column |  | Y |
| act_added_api_p_mthly_id | BIGINT | column |  | Y |
| act_first_app_p_mthly_id | BIGINT | column |  | Y |
| act_first_dx_p_mthly_id | BIGINT | column |  | Y |
| act_first_xxl_p_mthly_id | BIGINT | column |  | Y |
| act_first_other_p_mthly_id | BIGINT | column |  | Y |
| act_first_apitoapp_p_mthly_id | BIGINT | column |  | Y |
| act_added_p_mthly_id | BIGINT | column |  | Y |
| act_a24_p_mthly_id | INT | column |  | Y |
| act_added_apitoapp_p_mthly_id | BIGINT | column |  | Y |
