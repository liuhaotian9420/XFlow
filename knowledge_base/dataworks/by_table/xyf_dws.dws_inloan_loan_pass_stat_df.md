...
| --- | --- | --- | --- | --- |
| cust_no | STRING | column | [AI推测] 客户号 | Y |
| inner_app | STRING | column | [AI推测] 内部渠道标识 |  |
| app | STRING | column | [AI推测] 应用标识 |  |
| loan_type_flag | STRING | column | [AI推测] 贷款类型（首贷/复贷/加贷） |  |
| order_number | STRING | column | [AI推测] 订单号 |  |
| amt | DECIMAL(38,18) | column | [AI推测] 订单金额（元） |  |
| created_time | DATETIME | column | [AI推测] 订单创建时间 | Y |
| risk_status | STRING | column | [AI推测] 风控状态（pass/reject） | Y |
| remit_status | STRING | column | [AI推测] 放款状态（success/failed） |  |
| pay_time | DATETIME | column | [AI推测] 放款时间 |  |
| loan_rn | BIGINT | column | [AI推测] 贷款序号（用户维度） |  |
| b_cust_no | STRING | column | [AI推测] 上一笔订单客户号 |  |
| b_pay_time | DATETIME | column | [AI推测] 上一笔订单放款时间 | Y |
| b_inner_app | STRING | column | [AI推测] 上一笔订单内部渠道 |  |
| c_cust_no | STRING | column | [AI推测] 下一笔订单客户号 |  |
| c_created_time | DATETIME | column | [AI推测] 下一笔订单创建时间 | Y |
| is_refuse_recent30 | STRING | column | [AI推测] 近30天是否被拒（0/1） |  |
