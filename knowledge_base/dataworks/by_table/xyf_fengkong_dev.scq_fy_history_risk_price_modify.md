...
| --- | --- | --- | --- | --- |
| order_number | STRING | column | [AI推测] 订单号（子订单） |  |
| ori_order_number | STRING | column | [AI推测] 原始订单号（主订单） | Y |
| 输出风险定价 | STRING | column | [AI推测] 输出风险定价等级（如I24/I36） |  |
| 是否结清 | STRING | column | [AI推测] 贷款状态（在贷/结清） |  |
